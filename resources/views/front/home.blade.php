        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{asset('admin-assets/img/Mens-Fashion.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>Mens</h2>
                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{asset('admin-assets/img/Womens-Fashion.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>Womens</h2>
                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{asset('admin-assets/img/Kids-Fashion.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>Kids</h2>
                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{asset('admin-assets/img/accessories.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>accessories</h2>
